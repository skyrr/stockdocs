...
public class FragmentViewPager extends Fragment {
    ...
    public static FragmentViewPager newInstance(String param1, String param2) {
...
//        ViewPager vpPager = (ViewPager) container.findViewById(R.id.vpPager);
//        adapterViewPager = new MyPagerAdapter(getSupportFragmentManager());
//        vpPager.setAdapter(adapterViewPager);
//        vpPager.getCurrentItem(); // --> 2
//        vpPager.setCurrentItem(1);
        View view = inflater.inflate(R.layout.fragment_fragment_view_pager,
                container, false);
